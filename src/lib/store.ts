  ...
  global.__duoples_build_store = {
    ...
    logs: [
      ...
      },
      {
        ...
        timestamp: new Date(Date.now() - 900000).toISOString(),
        level: "info",
        text: " DuoplesOS Cloud Build Agent - Crave.io Cluster",
        stage: "repo_sync",
      },
      {
        id: "log_3",
      ...
      },
      {
        ...
        level: "info",
        text: " [Crave.io] Job #299163 scheduled on LOS 23.2 project base (ID: 99)",
        stage: "repo_sync",
      },
      {
        id: "log_5",
        ...
        level: "info",
        text: " [Crave.io] Public repo ingested: https://github.com/Duoples/duoplesos-rom",
        stage: "repo_sync",
      },
      {
        id: "log_6",
        ...
        level: "info",
        text: " [Crave.io] Bundled latest DuoplesAppstore.apk (v0.7.1, Build 710)",
        stage: "apply_patches",
      },
      {
        id: "log_7",
        ...
        level: "info",
        text: " [Crave.io] Sync engine /opt/crave/resync.sh initialized (FOSS compliant)",
        stage: "repo_sync",
      },
      {
        id: "log_8",
        ...
        level: "info",
        text: " [*] Cloud build job active in queue: https://foss.crave.io/app/#/build/info/299163?team=14",
        stage: "repo_sync",
      },
    ],
    subscriptions: [],
