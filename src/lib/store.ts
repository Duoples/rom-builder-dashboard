  ...
  global.__duoples_build_store = {
    ...
    logs: [
      ...
      },
      {
        ...
        level: "info",
        text: " [100% 135/135] analyzing Android.bp files and generating ninja graph",
      ...
      },
      {
        ...
        level: "info",
        text: " [ 42% 14208/33824] Building CXX object out/target/product/violet/obj/libart.so",
        stage: "ninja_compilation",
      },
    ],
    subscriptions: [],
